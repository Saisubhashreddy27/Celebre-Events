          ...
          <div className="space-y-6 animate-fade-in" id="step_occasion_type">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 pt-1">
              {[
                ...
                { type: 'FirstJob', label: 'First Job', image: 'https://images.unsplash.com/photo-1521791136064-7986c2920216?auto=format&fit=crop&w=300&q=80', desc: 'Congratulatory career steps, advice cards, & celebratory streams' },
